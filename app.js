(function () {
  ...
  const TEXT = {
    zh: {
      ...
      unlock: "解锁",
      wrongPin: "密码不对 (｡>﹏<｡)",
      reminderButtonNone: "闹钟：无",
      reminderButtonPrefix: "闹钟",
      advanceReminder: "首次响铃",
      followReminder: "后续响铃",
      advanceNone: "响铃：无",
      followOnce: "只响一次",
      followEvery: "持续：每",
      todoReminderDefaultLabel: "待办闹钟默认",
    ...
    ja: {
      ...
      reminderButtonNone: "アラーム：なし",
      reminderButtonPrefix: "アラーム",
      advanceReminder: "最初のアラーム",
      followReminder: "後続アラーム",
      advanceNone: "アラーム：なし",
      followOnce: "1回だけ",
      followEvery: "継続：",
      todoReminderDefaultLabel: "ToDoアラームの初期値",
    ...
    en: {
      ...
      reminderButtonNone: "Alarm: off",
      reminderButtonPrefix: "Alarm",
      advanceReminder: "First alarm",
      followReminder: "Follow-up alarm",
      advanceNone: "Alarm: off",
      followOnce: "Once",
      followEvery: "Repeat every",
      todoReminderDefaultLabel: "Todo alarm default",
